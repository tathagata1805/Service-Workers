// STORAGE IS THE AMOUNT OF STORAGE THE BROWSER HAS FOR THE CURRENT ORIGIN...
// REFER THIS DOC FOR STORAGE SPECS:- https://storage.spec.whatwg.org/#storage-quota
// REFER THIS DOC FOR STORAGE MANAGER:- https://developer.mozilla.org/en-US/docs/Web/API/StorageManager
    ...
    getCacheSize() {
      ...
      if ('storage' in navigator) {
        if ('estimate' in navigator.storage) {
          ...
          console.log('No support for Storage Manager methods');
        }
      }
