// INTRO TO INDEXEDDB:-
// STORING DATA OBJECTS IN INDEXEDDB AND FETCHING THEM ON THE BROWSER..
...
//starter images
let imageAssets = ["/img/ava-01.png", "/img/ava-02.png"];
//TODO:
let DB = null;
              ...
              if (fetchResponse.status == 404) {
                ...
                if (
                  ...
                  return caches.open(imageName).then((cache) => {
                    return cache.match("/img/ava-02.png");
                  });
                }
              }
            },
...
// FLOW OF THE DATABASE INTEGRATION:-

// INSIDE OF THE MESSAGE LISTENER -> 
// WE CHECK FOR THE DATABASE -> 
// CALLS SAVEPERSON FUNCTION ->
// SAVEPERSON CREATES A TRANSACTION TO WORK IN THE DB -> 
// CONNECTS TO THE STORE -> 
// CALLS THE PUT METHOD ->
// PUT METHOD SAVES THE PERSON -> 
// ONCE COMPLETED, ITS CALLS ONCOMPLETE FUNCTIONN AND DISPLAYS THE MSG